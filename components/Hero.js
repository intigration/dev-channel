      ...
      <header className={`px-2 mt-12 ${className}`}>
        <div className="text-center">
          ...
          <Heading level="h2" typeStyle="body-lg" textColor="text-gray-700" className="mb-10 max-w-4xl mx-auto">
            NextGen tools to easily build and maintain your 
            architecture. All powered by the specialized domain knowledge, the {" "}
            <strong>industry standard</strong> for defining the future .
          </Heading>
