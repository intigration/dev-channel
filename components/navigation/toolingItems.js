...
export default [
  { href: 'https://studio.asyncapi.com/', icon: IconHub, title: 'Continous Testing', description: 'Visually design your AsyncAPI files and event-driven architecture.', beta: true },
