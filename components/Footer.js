          ...
          <div className="mr-14 w-full md:w-auto">
            ...
            <div className="">
              <Heading className="mt-12 mb-14 text-white" typeStyle="heading-sm-semibold">
                Building the future of <br/> Industrial Automation.
              </Heading>
            </div>
          </div>
              ...
              <div className="px-0 lg:px-10 lg:ml-5 mb-5">
                <div className="py-2">
                  <div className="text-white">
                    <Heading typeStyle="heading-sm-semibold">Initiative</Heading>
                  </div>
                </div>
                <ul className="justify-center">
                  <li className="py-2">
                    <Link href="/about">
                      <a className="text-base leading-6 text-cool-gray hover:text-white transition ease-in-out duration-300">About AIS</a>
                    </Link>
                  </li>
                  <li className="py-2">
                    <Link href="/blog">
                      <a className="text-base leading-6 text-cool-gray hover:text-white transition ease-in-out duration-300">Topics</a>
                    </Link>
                  </li>
                  <li className="py-2">
                  ...
                  <li className="py-2">
                    <Link href="/jobs">
                      <a className="text-base leading-6 text-cool-gray hover:text-white transition ease-in-out duration-300">Tooling</a>
                    </Link>
                  </li>
                  <li className="py-2">
        ...
        <div className="sm:flex justify-between xl:mt-20 py-8 sm:py-12">
          <div className="w-full sm:w-2/3">
            ...
            <p className="text-left text-sm leading-6 text-cool-gray w-full sm:w-2/3">
              Copyright &copy; AI Systems.
              <a href="https://testing.orionis.io" className="text-secondary-500 hover:text-white transition ease-in-out duration-300 underline" target="_blank" rel="noopener noreferrer">https://testing.orionis.io</a>
            </p>
          </div>
          <div className="block mt-8 sm:mt-0">
            <p className="block text-sm leading-6">
              <a href="https://netlify.com" target="_blank" rel="noopener noreferrer">
                <img src="https://www.netlify.com/img/global/badges/netlify-color-bg.svg" className="inline" alt="Deployed at Code"/>
              </a>
            </p>
          </div>
        </div>
